...
async function getDataPtn() {
    ...
    maxmin.innerText = Math.round(result.main.temp_min) + " / " + Math.round(result.main.temp_max) + "ºC"
    ...
    try {
        ...
        dia1.innerText = dias[dia1Value.getDay()] + ", " + dia1Value.getDate() + "/" + dia1Value.getMonth() + "/" + dia1Value.getFullYear()

        var dia2Value = new Date(result.daily[2].dt * 1000)
        dia2.innerText = dias[dia2Value.getDay()] + ", " + dia2Value.getDate() + "/" + dia2Value.getMonth() + "/" + dia2Value.getFullYear()

        var dia3Value = new Date(result.daily[3].dt * 1000)
        dia3.innerText = dias[dia3Value.getDay()] + ", " + dia3Value.getDate() + "/" + dia3Value.getMonth() + "/" + dia3Value.getFullYear()

        var dia4Value = new Date(result.daily[4].dt * 1000)
        dia4.innerText = dias[dia4Value.getDay()] + ", " + dia4Value.getDate() + "/" + dia4Value.getMonth() + "/" + dia4Value.getFullYear()

        var dia5Value = new Date(result.daily[5].dt * 1000)
        dia5.innerText = dias[dia5Value.getDay()] + ", " + dia5Value.getDate() + "/" + dia5Value.getMonth() + "/" + dia5Value.getFullYear()

        var dia6Value = new Date(result.daily[6].dt * 1000)
        dia6.innerText = dias[dia6Value.getDay()] + ", " + dia6Value.getDate() + "/" + dia6Value.getMonth() + "/" + dia6Value.getFullYear()

        var dia7Value = new Date(result.daily[7].dt * 1000)
        dia7.innerText = dias[dia7Value.getDay()] + ", " + dia7Value.getDate() + "/" + dia7Value.getMonth() + "/" + dia7Value.getFullYear()

        chanceChuvaDia1.innerText = Math.round((result.daily[1].pop) * 100) + "%" + " chance de chuva"
        chanceChuvaDia2.innerText = Math.round((result.daily[2].pop) * 100) + "%" + " chance de chuva"
        chanceChuvaDia3.innerText = Math.round((result.daily[3].pop) * 100) + "%" + " chance de chuva"
        chanceChuvaDia4.innerText = Math.round((result.daily[4].pop)) * 100 + "%" + " chance de chuva"
        chanceChuvaDia5.innerText = Math.round((result.daily[5].pop) * 100) + "%" + " chance de chuva"
        chanceChuvaDia6.innerText = Math.round((result.daily[6].pop)) * 100 + "%" + " chance de chuva"
        chanceChuvaDia7.innerText = Math.round((result.daily[7].pop)) * 100 + "%" + " chance de chuva"
